...
insert_db2 <- function(dat, log = "", excfl = "", tab = "") {
    save(dat, log, excfl, tab, file = "deb.RData")
    sqlite_dpth <- "data/sol_v5.db"
...
update_meta_page <- function(dbfl, xlfl) {
